  ...
  useEffect(() => {
    async function loadChar() {
      try {
        ...
        setLoading(false)
        // Manter monster como null para mostrar estado de erro
      }
    }
  ...
  return (
    <Styles.Container loading={loading}>
      {loading ? (
        ...
        <div>
          <h2>Monstro não encontrado</h2>
          <p>O monstro com ID {id} não foi encontrado.</p>
        </div>
      ) : (
        <>
              ...
              <Styles.BaseContainer>
                ...
                <Styles.LineContaniner>
                  <div>
                    <Styles.InputShort
                      readOnly
                      defaultValue={monster?.challenge}
                    />
